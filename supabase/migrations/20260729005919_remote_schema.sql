...
CREATE TYPE "public"."memo_section_code" AS ENUM (
    'executive_summary',
...
ALTER TYPE "public"."memo_section_code" OWNER TO "postgres";


CREATE TYPE "public"."memo_section_status" AS ENUM (
    'draft',
    'pending_validation',
    'validated',
    'needs_revision'
...
ALTER TYPE "public"."memo_section_status" OWNER TO "postgres";


CREATE TYPE "public"."memo_version_status" AS ENUM (
    'generating',
    'ready',
    'validated',
    'rejected'
...
ALTER TYPE "public"."memo_version_status" OWNER TO "postgres";
...
CREATE TYPE "public"."pe_dd_category" AS ENUM (
    'financier',
    'juridique',
    'commercial',
    'operationnel',
...
ALTER TYPE "public"."pe_dd_category" OWNER TO "postgres";


CREATE TYPE "public"."pe_dd_checklist_status" AS ENUM (
    'pending',
    'verified',
    'red_flag',
    'na'
...
ALTER TYPE "public"."pe_dd_checklist_status" OWNER TO "postgres";


CREATE TYPE "public"."pe_dd_finding_status" AS ENUM (
    'open',
    'mitigated',
    'accepted',
    'rejected'
...
ALTER TYPE "public"."pe_dd_finding_status" OWNER TO "postgres";


CREATE TYPE "public"."pe_dd_finding_type" AS ENUM (
    'confirmation',
    'adjustment',
    'red_flag',
    'informative'
...
ALTER TYPE "public"."pe_dd_finding_type" OWNER TO "postgres";


CREATE TYPE "public"."pe_dd_report_type" AS ENUM (
    'financiere',
    'juridique',
    'esg',
    'fiscale',
...
ALTER TYPE "public"."pe_dd_report_type" OWNER TO "postgres";


CREATE TYPE "public"."pe_dd_severity" AS ENUM (
    'Critical',
    'High',
    'Medium',
    'Low'
...
ALTER TYPE "public"."pe_dd_severity" OWNER TO "postgres";


CREATE TYPE "public"."pe_deal_source" AS ENUM (
    'reseau_pe',
    'inbound',
    'dfi',
    'banque',
...
ALTER TYPE "public"."pe_deal_source" OWNER TO "postgres";


CREATE TYPE "public"."pe_deal_stage" AS ENUM (
    'sourcing',
    'pre_screening',
    'analyse',
    'note_ic1',
...
ALTER TYPE "public"."pe_deal_stage" OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."can_access_documents_object"("_name" "text") RETURNS boolean
...
ALTER FUNCTION "public"."can_access_documents_object"("_name" "text") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."can_see_pe_deal"("p_deal_id" "uuid", "p_user_id" "uuid") RETURNS boolean
...
ALTER FUNCTION "public"."can_see_pe_deal"("p_deal_id" "uuid", "p_user_id" "uuid") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."enforce_pe_deal_invariants"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
...
ALTER FUNCTION "public"."enforce_pe_deal_invariants"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."generate_pe_deal_ref"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
DECLARE
  org_code TEXT;
...
ALTER FUNCTION "public"."generate_pe_deal_ref"() OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."get_pe_role"("p_org_id" "uuid", "p_user_id" "uuid") RETURNS "text"
    LANGUAGE "sql" STABLE SECURITY DEFINER
    SET "search_path" TO ''
    AS $$
...
ALTER FUNCTION "public"."get_pe_role"("p_org_id" "uuid", "p_user_id" "uuid") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."has_enterprise_access"("_enterprise_id" "uuid") RETURNS boolean
    LANGUAGE "sql" STABLE SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
...
ALTER FUNCTION "public"."has_enterprise_access"("_enterprise_id" "uuid") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."is_pe_md_or_owner"("p_org_id" "uuid", "p_user_id" "uuid") RETURNS boolean
    LANGUAGE "sql" STABLE SECURITY DEFINER
    SET "search_path" TO ''
    AS $$
  SELECT EXISTS (
...
ALTER FUNCTION "public"."is_pe_md_or_owner"("p_org_id" "uuid", "p_user_id" "uuid") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."is_supervising_analyst"("p_org_id" "uuid", "p_im_user" "uuid", "p_analyst_user" "uuid") RETURNS boolean
    LANGUAGE "sql" STABLE SECURITY DEFINER
    SET "search_path" TO ''
    AS $$
  SELECT EXISTS (
...
ALTER FUNCTION "public"."is_supervising_analyst"("p_org_id" "uuid", "p_im_user" "uuid", "p_analyst_user" "uuid") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."pe_create_memo_snapshot"("p_version_id" "uuid", "p_label" "text", "p_user_id" "uuid") RETURNS "uuid"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
DECLARE
...
BEGIN
  ...
  IF NOT FOUND THEN RAISE EXCEPTION 'Version % introuvable', p_version_id; END IF;
  IF v_source_version.is_snapshot THEN RAISE EXCEPTION 'On ne crée pas de snapshot d''un snapshot (version % est déjà un snapshot)', p_version_id; END IF;

  INSERT INTO memo_versions (
    memo_id, label, parent_version_id, stage, status, overall_score, classification,
    generated_by_agent, generated_by_user_id, generated_at, error_message,
    ...
    v_source_version.id, v_source_version.stage, v_source_version.status,
    v_source_version.overall_score, v_source_version.classification,
    'snapshot', p_user_id, v_source_version.generated_at, NULL,
    true, p_label, p_version_id, now(), p_user_id
  ) RETURNING id INTO v_snapshot_id;

  INSERT INTO memo_sections (
    version_id, section_code, title, content_md, content_json,
    source_doc_ids, position, status, last_edited_by, last_edited_at,
    created_at, updated_at
  )
  SELECT v_snapshot_id, section_code, title, content_md, content_json,
    source_doc_ids, position, status, last_edited_by, last_edited_at,
    created_at, now()
  FROM memo_sections WHERE version_id = p_version_id;
...
ALTER FUNCTION "public"."pe_create_memo_snapshot"("p_version_id" "uuid", "p_label" "text", "p_user_id" "uuid") OWNER TO "postgres";
...
BEGIN
  RETURN QUERY
  SELECT kb.id, kb.title, kb.content, kb.category, kb.source, kb.country, kb.sector,
...
CREATE OR REPLACE FUNCTION "public"."set_memo_sections_updated_at"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
...
ALTER FUNCTION "public"."set_memo_sections_updated_at"() OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."set_pe_deal_documents_uploaded_by"() RETURNS "trigger"
    LANGUAGE "plpgsql" SECURITY DEFINER
    AS $$
BEGIN
...
ALTER FUNCTION "public"."set_pe_deal_documents_uploaded_by"() OWNER TO "postgres";


COMMENT ON FUNCTION "public"."set_pe_deal_documents_uploaded_by"() IS 'Force uploaded_by = auth.uid() si l''INSERT envoie NULL. Filet de sécurité pour les composants frontend qui oublient de passer le user_id.';
...
CREATE OR REPLACE FUNCTION "public"."track_pe_deal_stage_change"() RETURNS "trigger"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO ''
    AS $$
BEGIN
...
ALTER FUNCTION "public"."track_pe_deal_stage_change"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."update_efc_timestamp"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
...
ALTER FUNCTION "public"."update_efc_timestamp"() OWNER TO "postgres";


COMMENT ON FUNCTION "public"."update_efc_timestamp"() IS 'Bump version + last_updated_at automatiquement à chaque UPDATE.';



CREATE OR REPLACE FUNCTION "public"."update_pe_dd_updated_at"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN NEW.updated_at = now(); RETURN NEW; END;
$$;
...
ALTER FUNCTION "public"."update_pe_dd_updated_at"() OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."ai_jobs" (
    ...
    "duration_ms" integer,
    CONSTRAINT "ai_jobs_error_kind_check" CHECK ((("error_kind" IS NULL) OR ("error_kind" = ANY (ARRAY['timeout'::"text", 'api_error'::"text", 'validation_error'::"text", 'other'::"text"])))),
    CONSTRAINT "ai_jobs_status_check" CHECK (("status" = ANY (ARRAY['pending'::"text", 'running'::"text", 'ready'::"text", 'error'::"text"])))
);
...
CREATE TABLE IF NOT EXISTS "public"."candidatures" (
    ...
    "recovery_requested_docs" "jsonb" DEFAULT '[]'::"jsonb" NOT NULL,
...
COMMENT ON COLUMN "public"."candidatures"."recovery_token" IS 'Token aléatoire pour générer un lien de rattrapage (cas où uploads ont échoué).';



COMMENT ON COLUMN "public"."candidatures"."recovery_expires_at" IS 'Date d''expiration du token (généralement 7 jours après création).';



COMMENT ON COLUMN "public"."candidatures"."recovery_used_at" IS 'Date à laquelle le candidat a utilisé le lien (token consommé).';



COMMENT ON COLUMN "public"."candidatures"."recovery_requested_docs" IS 'Libellés des documents demandés sur-mesure au candidat via le lien de complétion (recovery). Ex: ["RIB","Attestation fiscale"].';
...
CREATE TABLE IF NOT EXISTS "public"."credit_dossiers" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "organization_id" "uuid" NOT NULL,
    "enterprise_id" "uuid" NOT NULL,
    "numero" "text",
    ...
    "duree_mois" integer,
    "type_credit" "text",
    "pipeline_status" "text" DEFAULT 'accueil'::"text" NOT NULL,
    "classification_diagnostic" "text",
    "classification_monitoring" "text",
    "conseiller_id" "uuid",
    "analyste_id" "uuid",
    "produit_retenu_code" "text",
    "funding_line_id" "uuid",
...
ALTER TABLE "public"."credit_dossiers" OWNER TO "postgres";
...
ALTER TABLE "public"."enterprise_coach_invitations" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."enterprise_financial_canonical" (
    "enterprise_id" "uuid" NOT NULL,
    ...
    "coherence_last_check_at" timestamp with time zone,
    "coherence_status" "text" DEFAULT 'non_verifie'::"text" NOT NULL,
    CONSTRAINT "chk_payback_positive" CHECK ((("payback_years" IS NULL) OR ("payback_years" >= (0)::numeric))),
    CONSTRAINT "chk_tri_range" CHECK ((("tri_pct" IS NULL) OR (("tri_pct" >= ('-100'::integer)::numeric) AND ("tri_pct" <= (500)::numeric)))),
    CONSTRAINT "chk_wacc_range" CHECK ((("wacc_pct" IS NULL) OR (("wacc_pct" >= (0)::numeric) AND ("wacc_pct" <= (100)::numeric)))),
    CONSTRAINT "enterprise_financial_canonical_coherence_status_check" CHECK (("coherence_status" = ANY (ARRAY['non_verifie'::"text", 'verifie_avertissements'::"text", 'verifie_ok'::"text"])))
);


ALTER TABLE "public"."enterprise_financial_canonical" OWNER TO "postgres";


COMMENT ON TABLE "public"."enterprise_financial_canonical" IS 'Single Source of Truth des chiffres financiers d''une entreprise. Écrit par generate-plan-financier (projections+invest) et generate-valuation (WACC+valos). Lu par tous les autres agents IA.';
...
CREATE TABLE IF NOT EXISTS "public"."funding_lines" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "organization_id" "uuid" NOT NULL,
    "code" "text" NOT NULL,
    "label" "text" NOT NULL,
    ...
    "bailleur" "text",
    "devise" "text",
    "capacite_totale" numeric,
    "montant_deploye" numeric DEFAULT 0,
    "criteres_eligibilite" "jsonb",
    "kpi_a_reporter" "text"[],
    "taux_partage_risque" numeric,
    "taux_preferentiel" numeric,
    "is_active" boolean DEFAULT true,
    "metadata" "jsonb",
    "created_at" timestamp with time zone DEFAULT "now"(),
    "updated_at" timestamp with time zone DEFAULT "now"(),
    CONSTRAINT "funding_lines_type_check" CHECK (("type" = ANY (ARRAY['dfi'::"text", 'fonds_propres'::"text", 'garantie'::"text", 'programme'::"text"])))
);


ALTER TABLE "public"."funding_lines" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."knowledge_enrichment_log" (
    ...
    "sources_refreshed" integer DEFAULT 0 NOT NULL,
    "new_discovered" integer DEFAULT 0 NOT NULL,
    "auto_ingested" integer DEFAULT 0 NOT NULL,
...
ALTER TABLE "public"."knowledge_enrichment_log" OWNER TO "postgres";
...
ALTER TABLE "public"."knowledge_pending_review" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."memo_section_validations" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "section_id" "uuid" NOT NULL,
    "action" "text" NOT NULL,
    "from_status" "public"."memo_section_status",
    "to_status" "public"."memo_section_status" NOT NULL,
    "actor_id" "uuid" NOT NULL,
    "actor_role" "text",
    "comment" "text",
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "memo_section_validations_action_check" CHECK (("action" = ANY (ARRAY['submit'::"text", 'validate'::"text", 'request_revision'::"text", 'reset_to_draft'::"text"])))
);


ALTER TABLE "public"."memo_section_validations" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."memo_sections" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "version_id" "uuid" NOT NULL,
    "section_code" "public"."memo_section_code" NOT NULL,
    "title" "text",
    "content_md" "text",
    "content_json" "jsonb",
    ...
    "status" "public"."memo_section_status" DEFAULT 'draft'::"public"."memo_section_status" NOT NULL
);


ALTER TABLE "public"."memo_sections" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."memo_versions" (
    ...
    "label" "text" NOT NULL,
    "stage" "public"."pe_deal_stage" NOT NULL,
    "status" "public"."memo_version_status" DEFAULT 'generating'::"public"."memo_version_status" NOT NULL,
    ...
    "snapshot_label" "text",
    "snapshot_of_version_id" "uuid",
    "snapshot_taken_at" timestamp with time zone,
    "snapshot_taken_by" "uuid"
);


ALTER TABLE "public"."memo_versions" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."organization_invitations" (
    ...
    "created_at" timestamp with time zone DEFAULT "now"(),
    "enterprise_id" "uuid",
    "programme_ids" "uuid"[] DEFAULT '{}'::"uuid"[] NOT NULL,
    CONSTRAINT "organization_invitations_role_check" CHECK (("role" = ANY (ARRAY['owner'::"text", 'admin'::"text", 'manager'::"text", 'analyst'::"text", 'coach'::"text", 'entrepreneur'::"text", 'conseiller_pme'::"text", 'analyste_credit'::"text", 'directeur_agence'::"text", 'direction_pme'::"text", 'directeur_pme'::"text", 'partner'::"text"])))
);
...
COMMENT ON COLUMN "public"."organization_invitations"."programme_ids" IS 'IDs de programmes dont l''invité devient chef_programme_id à l''acceptation (rôle manager).';
...
CREATE TABLE IF NOT EXISTS "public"."organization_members" (
    ...
    "is_active" boolean DEFAULT true,
    CONSTRAINT "organization_members_role_check" CHECK (("role" = ANY (ARRAY['owner'::"text", 'admin'::"text", 'manager'::"text", 'analyst'::"text", 'coach'::"text", 'entrepreneur'::"text", 'conseiller_pme'::"text", 'analyste_credit'::"text", 'directeur_agence'::"text", 'direction_pme'::"text", 'directeur_pme'::"text", 'partner'::"text", 'managing_director'::"text", 'investment_manager'::"text", 'analyste'::"text"])))
);
...
CREATE TABLE IF NOT EXISTS "public"."organization_presets" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "organization_id" "uuid" NOT NULL,
    "fund_segment" "text",
    "devise" "text",
    "langue" "text" DEFAULT 'fr'::"text" NOT NULL,
    "horizon_projection" integer,
    ...
    "created_at" timestamp with time zone DEFAULT "now"(),
    "updated_at" timestamp with time zone DEFAULT "now"(),
    CONSTRAINT "organization_presets_fund_segment_check" CHECK (("fund_segment" = ANY (ARRAY['amorcage'::"text", 'mid_market'::"text", 'gros_tickets'::"text"]))),
    CONSTRAINT "organization_presets_horizon_projection_check" CHECK (("horizon_projection" = ANY (ARRAY[5, 7, 10])))
);


ALTER TABLE "public"."organization_presets" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."organization_workflows" (
    ...
    "is_active" boolean DEFAULT true,
    "created_at" timestamp with time zone DEFAULT "now"(),
    CONSTRAINT "organization_workflows_type_check" CHECK (("type" = ANY (ARRAY['action'::"text", 'decision'::"text", 'external'::"text"])))
);


ALTER TABLE "public"."organization_workflows" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."organizations" (
    ...
    CONSTRAINT "organizations_type_check" CHECK (("type" = ANY (ARRAY['programme'::"text", 'pe'::"text", 'mixed'::"text", 'banque_affaires'::"text", 'banque'::"text"])))
);
...
CREATE TABLE IF NOT EXISTS "public"."pe_dd_checklist" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "deal_id" "uuid" NOT NULL,
    "organization_id" "uuid" NOT NULL,
    "category" "public"."pe_dd_category" NOT NULL,
    "item_label" "text" NOT NULL,
    "item_description" "text",
    "status" "public"."pe_dd_checklist_status" DEFAULT 'pending'::"public"."pe_dd_checklist_status" NOT NULL,
    "responsable_user_id" "uuid",
    "due_date" "date",
    "evidence_doc_ids" "uuid"[] DEFAULT '{}'::"uuid"[] NOT NULL,
...
ALTER TABLE "public"."pe_dd_checklist" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."pe_dd_findings" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "deal_id" "uuid" NOT NULL,
    "organization_id" "uuid" NOT NULL,
    "category" "public"."pe_dd_category" NOT NULL,
    "severity" "public"."pe_dd_severity" NOT NULL,
    "title" "text" NOT NULL,
    "body" "text" NOT NULL,
    "recommendation" "text",
    "impacts_section_codes" "text"[] DEFAULT '{}'::"text"[] NOT NULL,
    "related_checklist_id" "uuid",
    "evidence_doc_ids" "uuid"[] DEFAULT '{}'::"uuid"[] NOT NULL,
    "status" "public"."pe_dd_finding_status" DEFAULT 'open'::"public"."pe_dd_finding_status" NOT NULL,
    "resolved_at" timestamp with time zone,
    "resolved_by" "uuid",
    "resolution_note" "text",
    "applied_to_memo_at" timestamp with time zone,
    "applied_to_memo_by" "uuid",
    "created_by" "uuid" NOT NULL,
    "source" "text" DEFAULT 'manual'::"text" NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "finding_type" "public"."pe_dd_finding_type" DEFAULT 'informative'::"public"."pe_dd_finding_type" NOT NULL,
    "source_paragraph" "text",
    "source_page" integer,
    "source_doc_id" "uuid",
    CONSTRAINT "pe_dd_findings_source_check" CHECK (("source" = ANY (ARRAY['ai'::"text", 'manual'::"text"])))
);


ALTER TABLE "public"."pe_dd_findings" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."pe_deal_documents" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "deal_id" "uuid" NOT NULL,
    "organization_id" "uuid" NOT NULL,
    "filename" "text" NOT NULL,
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "is_dd_report" boolean DEFAULT false NOT NULL,
    "dd_report_type" "public"."pe_dd_report_type",
    "dd_report_cabinet" "text",
    "dd_report_pages" integer
);


ALTER TABLE "public"."pe_deal_documents" OWNER TO "postgres";


COMMENT ON COLUMN "public"."pe_deal_documents"."uploaded_by" IS 'User qui a uploadé. Auto-rempli par trigger trg_set_uploaded_by depuis auth.uid() si possible. Peut rester NULL si l''INSERT vient d''un contexte sans JWT user (à corriger côté frontend en passant explicitement user.id).';



CREATE TABLE IF NOT EXISTS "public"."pe_deal_history" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "deal_id" "uuid" NOT NULL,
    "from_stage" "public"."pe_deal_stage",
    "to_stage" "public"."pe_deal_stage" NOT NULL,
    "changed_by" "uuid",
    "reason" "text",
    "created_at" timestamp with time zone DEFAULT "now"()
);
...
ALTER TABLE "public"."pe_deal_history" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."pe_deals" (
    ...
    "stage" "public"."pe_deal_stage" DEFAULT 'sourcing'::"public"."pe_deal_stage" NOT NULL,
    "lead_analyst_id" "uuid",
    "ticket_demande" numeric,
    "currency" "text" DEFAULT 'EUR'::"text",
    "source" "public"."pe_deal_source" DEFAULT 'autre'::"public"."pe_deal_source",
    "source_detail" "text",
    "score_360" integer,
    "lost_reason" "text",
    "created_by" "uuid",
...
ALTER TABLE "public"."pe_deals" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."pe_team_assignments" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "organization_id" "uuid" NOT NULL,
    "im_user_id" "uuid" NOT NULL,
...
ALTER TABLE "public"."pe_team_assignments" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."pe_valuation" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "deal_id" "uuid" NOT NULL,
    "organization_id" "uuid" NOT NULL,
    "dcf_inputs" "jsonb" DEFAULT '{}'::"jsonb" NOT NULL,
    "dcf_projections" "jsonb" DEFAULT '[]'::"jsonb" NOT NULL,
    "dcf_terminal" "jsonb" DEFAULT '{}'::"jsonb" NOT NULL,
    "dcf_outputs" "jsonb" DEFAULT '{}'::"jsonb" NOT NULL,
    "multiples_comparables" "jsonb" DEFAULT '[]'::"jsonb" NOT NULL,
    "multiples_outputs" "jsonb" DEFAULT '{}'::"jsonb" NOT NULL,
    "ancc_assets" "jsonb" DEFAULT '[]'::"jsonb" NOT NULL,
    "ancc_liabilities" "jsonb" DEFAULT '[]'::"jsonb" NOT NULL,
    "ancc_outputs" "jsonb" DEFAULT '{}'::"jsonb" NOT NULL,
    "synthesis" "jsonb" DEFAULT '{}'::"jsonb" NOT NULL,
    ...
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    CONSTRAINT "pe_valuation_status_check" CHECK (("status" = ANY (ARRAY['draft'::"text", 'generating'::"text", 'ready'::"text", 'error'::"text"])))
);


ALTER TABLE "public"."pe_valuation" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."programmes" (
    ...
    "form_presentation" "text",
    "form_base_lang" "text" DEFAULT 'fr'::"text" NOT NULL,
    "form_translations" "jsonb" DEFAULT '{}'::"jsonb" NOT NULL,
...
COMMENT ON COLUMN "public"."programmes"."partner_logos" IS 'Logos partenaires affichés en bande sur le formulaire public. Tableau JSONB : [{ "url": "...", "name": "..." }].';



COMMENT ON COLUMN "public"."programmes"."default_fields" IS 'Config des champs par défaut du formulaire de candidature : [{ "key", "label", "enabled", "required" }]. Fusionnée côté app avec le canon (src/lib/default-fields.ts). Vide = tous les champs par défaut actifs.';



COMMENT ON COLUMN "public"."programmes"."form_presentation" IS 'Présentation publique du formulaire de candidature (Markdown, visible par les candidats). Distincte de description (usage interne).';



COMMENT ON COLUMN "public"."programmes"."form_base_lang" IS 'Langue de rédaction du formulaire (colonnes de base : name, form_presentation, default_fields, form_fields). Les autres langues vivent dans form_translations.';



COMMENT ON COLUMN "public"."programmes"."form_translations" IS 'Traductions du formulaire par code langue : { <lang>: { presentation, default_fields:{key:label}, form_fields:{fieldId:{label, options:{value:label}}} } }. La langue de base n''y figure pas.';
...
ALTER TABLE ONLY "public"."candidatures"
    ADD CONSTRAINT "candidatures_recovery_token_key" UNIQUE ("recovery_token");
...
ALTER TABLE ONLY "public"."credit_dossiers"
    ADD CONSTRAINT "credit_dossiers_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."enterprise_coach_invitations"
    ADD CONSTRAINT "enterprise_coach_invitations_enterprise_id_invitation_id_key" UNIQUE ("enterprise_id", "invitation_id");



ALTER TABLE ONLY "public"."enterprise_coach_invitations"
    ADD CONSTRAINT "enterprise_coach_invitations_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."enterprise_financial_canonical"
    ADD CONSTRAINT "enterprise_financial_canonical_pkey" PRIMARY KEY ("enterprise_id");
...
ALTER TABLE ONLY "public"."funding_lines"
    ADD CONSTRAINT "funding_lines_organization_id_code_key" UNIQUE ("organization_id", "code");



ALTER TABLE ONLY "public"."funding_lines"
    ADD CONSTRAINT "funding_lines_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."investment_memos"
    ADD CONSTRAINT "investment_memos_deal_id_key" UNIQUE ("deal_id");
...
ALTER TABLE ONLY "public"."knowledge_enrichment_log"
    ADD CONSTRAINT "knowledge_enrichment_log_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."knowledge_pending_review"
    ADD CONSTRAINT "knowledge_pending_review_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."memo_section_validations"
    ADD CONSTRAINT "memo_section_validations_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."memo_sections"
    ADD CONSTRAINT "memo_sections_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."memo_sections"
    ADD CONSTRAINT "memo_sections_unique_code" UNIQUE ("version_id", "section_code");
...
ALTER TABLE ONLY "public"."memo_versions"
    ADD CONSTRAINT "memo_versions_unique_label" UNIQUE ("memo_id", "label");
...
ALTER TABLE ONLY "public"."organization_presets"
    ADD CONSTRAINT "organization_presets_organization_id_key" UNIQUE ("organization_id");



ALTER TABLE ONLY "public"."organization_presets"
    ADD CONSTRAINT "organization_presets_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."organization_workflows"
    ADD CONSTRAINT "organization_workflows_organization_id_etape_id_key" UNIQUE ("organization_id", "etape_id");



ALTER TABLE ONLY "public"."organization_workflows"
    ADD CONSTRAINT "organization_workflows_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."pe_dd_checklist"
    ADD CONSTRAINT "pe_dd_checklist_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."pe_dd_findings"
    ADD CONSTRAINT "pe_dd_findings_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."pe_deal_documents"
    ADD CONSTRAINT "pe_deal_documents_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."pe_deal_documents"
    ADD CONSTRAINT "pe_deal_documents_storage_path_key" UNIQUE ("storage_path");



ALTER TABLE ONLY "public"."pe_deal_history"
    ADD CONSTRAINT "pe_deal_history_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."pe_deals"
    ADD CONSTRAINT "pe_deals_organization_id_deal_ref_key" UNIQUE ("organization_id", "deal_ref");



ALTER TABLE ONLY "public"."pe_deals"
    ADD CONSTRAINT "pe_deals_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."pe_team_assignments"
    ADD CONSTRAINT "pe_team_assignments_organization_id_im_user_id_analyst_user_key" UNIQUE ("organization_id", "im_user_id", "analyst_user_id");



ALTER TABLE ONLY "public"."pe_team_assignments"
    ADD CONSTRAINT "pe_team_assignments_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."pe_valuation"
    ADD CONSTRAINT "pe_valuation_deal_unique" UNIQUE ("deal_id");



ALTER TABLE ONLY "public"."pe_valuation"
    ADD CONSTRAINT "pe_valuation_pkey" PRIMARY KEY ("id");
...
CREATE INDEX "idx_ai_jobs_organization_id" ON "public"."ai_jobs" USING "btree" ("organization_id") WHERE ("organization_id" IS NOT NULL);



CREATE INDEX "idx_ai_jobs_programme_id" ON "public"."ai_jobs" USING "btree" ("programme_id") WHERE ("programme_id" IS NOT NULL);
...
CREATE INDEX "idx_candidatures_recovery_token" ON "public"."candidatures" USING "btree" ("recovery_token") WHERE (("recovery_token" IS NOT NULL) AND ("recovery_used_at" IS NULL));
...
CREATE INDEX "idx_credit_dossiers_enterprise" ON "public"."credit_dossiers" USING "btree" ("enterprise_id");



CREATE INDEX "idx_credit_dossiers_org" ON "public"."credit_dossiers" USING "btree" ("organization_id");



CREATE INDEX "idx_credit_dossiers_status" ON "public"."credit_dossiers" USING "btree" ("organization_id", "pipeline_status");
...
CREATE INDEX "idx_eci_enterprise" ON "public"."enterprise_coach_invitations" USING "btree" ("enterprise_id");



CREATE INDEX "idx_eci_invitation" ON "public"."enterprise_coach_invitations" USING "btree" ("invitation_id");



CREATE INDEX "idx_eci_organization" ON "public"."enterprise_coach_invitations" USING "btree" ("organization_id");



CREATE INDEX "idx_efc_enterprise" ON "public"."enterprise_financial_canonical" USING "btree" ("enterprise_id");



CREATE INDEX "idx_efc_updated" ON "public"."enterprise_financial_canonical" USING "btree" ("last_updated_at" DESC);
...
CREATE INDEX "idx_funding_lines_org" ON "public"."funding_lines" USING "btree" ("organization_id") WHERE ("is_active" = true);
...
CREATE INDEX "idx_memo_section_validations_section" ON "public"."memo_section_validations" USING "btree" ("section_id", "created_at" DESC);



CREATE INDEX "idx_memo_sections_status" ON "public"."memo_sections" USING "btree" ("status");



CREATE INDEX "idx_memo_sections_version" ON "public"."memo_sections" USING "btree" ("version_id");



CREATE INDEX "idx_memo_versions_memo_recent" ON "public"."memo_versions" USING "btree" ("memo_id", "created_at" DESC);



CREATE INDEX "idx_memo_versions_snapshots" ON "public"."memo_versions" USING "btree" ("memo_id", "is_snapshot") WHERE ("is_snapshot" = true);



CREATE INDEX "idx_memo_versions_stage_status" ON "public"."memo_versions" USING "btree" ("stage", "status");
...
CREATE INDEX "idx_pe_dd_checklist_category" ON "public"."pe_dd_checklist" USING "btree" ("deal_id", "category");



CREATE INDEX "idx_pe_dd_checklist_deal" ON "public"."pe_dd_checklist" USING "btree" ("deal_id");



CREATE INDEX "idx_pe_dd_checklist_status" ON "public"."pe_dd_checklist" USING "btree" ("status", "deal_id");



CREATE INDEX "idx_pe_dd_findings_category" ON "public"."pe_dd_findings" USING "btree" ("deal_id", "category");



CREATE INDEX "idx_pe_dd_findings_deal" ON "public"."pe_dd_findings" USING "btree" ("deal_id");



CREATE INDEX "idx_pe_dd_findings_severity" ON "public"."pe_dd_findings" USING "btree" ("severity", "deal_id");



CREATE INDEX "idx_pe_dd_findings_status" ON "public"."pe_dd_findings" USING "btree" ("status", "deal_id");



CREATE INDEX "idx_pe_dd_findings_type" ON "public"."pe_dd_findings" USING "btree" ("deal_id", "finding_type");



CREATE INDEX "idx_pe_deal_documents_dd_report" ON "public"."pe_deal_documents" USING "btree" ("deal_id", "is_dd_report") WHERE ("is_dd_report" = true);



CREATE INDEX "idx_pe_deal_documents_dd_type" ON "public"."pe_deal_documents" USING "btree" ("deal_id", "dd_report_type") WHERE ("is_dd_report" = true);



CREATE INDEX "idx_pe_deal_documents_deal_id" ON "public"."pe_deal_documents" USING "btree" ("deal_id");



CREATE INDEX "idx_pe_deal_documents_org_recent" ON "public"."pe_deal_documents" USING "btree" ("organization_id", "created_at" DESC);



CREATE INDEX "idx_pe_deal_history_deal" ON "public"."pe_deal_history" USING "btree" ("deal_id", "created_at" DESC);



CREATE INDEX "idx_pe_deals_enterprise" ON "public"."pe_deals" USING "btree" ("enterprise_id");



CREATE INDEX "idx_pe_deals_lead_analyst" ON "public"."pe_deals" USING "btree" ("lead_analyst_id");



CREATE INDEX "idx_pe_deals_org_stage" ON "public"."pe_deals" USING "btree" ("organization_id", "stage");



CREATE INDEX "idx_pe_team_analyst" ON "public"."pe_team_assignments" USING "btree" ("analyst_user_id") WHERE ("is_active" = true);



CREATE INDEX "idx_pe_team_im" ON "public"."pe_team_assignments" USING "btree" ("im_user_id") WHERE ("is_active" = true);



CREATE INDEX "idx_pe_valuation_deal" ON "public"."pe_valuation" USING "btree" ("deal_id");



CREATE INDEX "idx_pe_valuation_org" ON "public"."pe_valuation" USING "btree" ("organization_id");
...
CREATE INDEX "knowledge_base_embedding_ivfflat" ON "public"."knowledge_base" USING "ivfflat" ("embedding" "extensions"."vector_cosine_ops") WITH ("lists"='100');
...
CREATE INDEX "knowledge_enrichment_log_run_date_idx" ON "public"."knowledge_enrichment_log" USING "btree" ("run_date" DESC);



CREATE INDEX "knowledge_pending_review_created_at_idx" ON "public"."knowledge_pending_review" USING "btree" ("created_at" DESC);



CREATE INDEX "knowledge_pending_review_status_idx" ON "public"."knowledge_pending_review" USING "btree" ("status");



CREATE OR REPLACE TRIGGER "credit_dossiers_set_updated_at" BEFORE UPDATE ON "public"."credit_dossiers" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();



CREATE OR REPLACE TRIGGER "funding_lines_set_updated_at" BEFORE UPDATE ON "public"."funding_lines" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();



CREATE OR REPLACE TRIGGER "pe_deals_enforce_invariants" BEFORE INSERT OR UPDATE ON "public"."pe_deals" FOR EACH ROW EXECUTE FUNCTION "public"."enforce_pe_deal_invariants"();



CREATE OR REPLACE TRIGGER "pe_deals_generate_ref" BEFORE INSERT ON "public"."pe_deals" FOR EACH ROW EXECUTE FUNCTION "public"."generate_pe_deal_ref"();



CREATE OR REPLACE TRIGGER "pe_deals_track_stage" AFTER INSERT OR UPDATE ON "public"."pe_deals" FOR EACH ROW EXECUTE FUNCTION "public"."track_pe_deal_stage_change"();
...
CREATE OR REPLACE TRIGGER "trg_efc_update_timestamp" BEFORE UPDATE ON "public"."enterprise_financial_canonical" FOR EACH ROW EXECUTE FUNCTION "public"."update_efc_timestamp"();



CREATE OR REPLACE TRIGGER "trg_memo_sections_updated_at" BEFORE UPDATE ON "public"."memo_sections" FOR EACH ROW EXECUTE FUNCTION "public"."set_memo_sections_updated_at"();



CREATE OR REPLACE TRIGGER "trg_pe_dd_checklist_updated_at" BEFORE UPDATE ON "public"."pe_dd_checklist" FOR EACH ROW EXECUTE FUNCTION "public"."update_pe_dd_updated_at"();



CREATE OR REPLACE TRIGGER "trg_pe_dd_findings_updated_at" BEFORE UPDATE ON "public"."pe_dd_findings" FOR EACH ROW EXECUTE FUNCTION "public"."update_pe_dd_updated_at"();



CREATE OR REPLACE TRIGGER "trg_pe_valuation_updated_at" BEFORE UPDATE ON "public"."pe_valuation" FOR EACH ROW EXECUTE FUNCTION "public"."update_updated_at_column"();
...
CREATE OR REPLACE TRIGGER "trg_set_uploaded_by" BEFORE INSERT ON "public"."pe_deal_documents" FOR EACH ROW EXECUTE FUNCTION "public"."set_pe_deal_documents_uploaded_by"();
...
ALTER TABLE ONLY "public"."ai_jobs"
    ADD CONSTRAINT "ai_jobs_programme_id_fkey" FOREIGN KEY ("programme_id") REFERENCES "public"."programmes"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."ai_jobs"
    ADD CONSTRAINT "ai_jobs_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "auth"."users"("id") ON DELETE SET NULL;
...
ALTER TABLE ONLY "public"."credit_dossiers"
    ADD CONSTRAINT "credit_dossiers_analyste_id_fkey" FOREIGN KEY ("analyste_id") REFERENCES "auth"."users"("id");



ALTER TABLE ONLY "public"."credit_dossiers"
    ADD CONSTRAINT "credit_dossiers_conseiller_id_fkey" FOREIGN KEY ("conseiller_id") REFERENCES "auth"."users"("id");



ALTER TABLE ONLY "public"."credit_dossiers"
    ADD CONSTRAINT "credit_dossiers_enterprise_id_fkey" FOREIGN KEY ("enterprise_id") REFERENCES "public"."enterprises"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."credit_dossiers"
    ADD CONSTRAINT "credit_dossiers_funding_line_id_fkey" FOREIGN KEY ("funding_line_id") REFERENCES "public"."funding_lines"("id");



ALTER TABLE ONLY "public"."credit_dossiers"
    ADD CONSTRAINT "credit_dossiers_organization_id_fkey" FOREIGN KEY ("organization_id") REFERENCES "public"."organizations"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."enterprise_coach_invitations"
    ADD CONSTRAINT "enterprise_coach_invitations_assigned_by_fkey" FOREIGN KEY ("assigned_by") REFERENCES "auth"."users"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."enterprise_coach_invitations"
    ADD CONSTRAINT "enterprise_coach_invitations_enterprise_id_fkey" FOREIGN KEY ("enterprise_id") REFERENCES "public"."enterprises"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."enterprise_coach_invitations"
    ADD CONSTRAINT "enterprise_coach_invitations_invitation_id_fkey" FOREIGN KEY ("invitation_id") REFERENCES "public"."organization_invitations"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."enterprise_coach_invitations"
    ADD CONSTRAINT "enterprise_coach_invitations_organization_id_fkey" FOREIGN KEY ("organization_id") REFERENCES "public"."organizations"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."enterprise_financial_canonical"
    ADD CONSTRAINT "enterprise_financial_canonical_enterprise_id_fkey" FOREIGN KEY ("enterprise_id") REFERENCES "public"."enterprises"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."funding_lines"
    ADD CONSTRAINT "funding_lines_organization_id_fkey" FOREIGN KEY ("organization_id") REFERENCES "public"."organizations"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."investment_memos"
    ADD CONSTRAINT "investment_memos_created_by_fkey" FOREIGN KEY ("created_by") REFERENCES "auth"."users"("id");



ALTER TABLE ONLY "public"."investment_memos"
    ADD CONSTRAINT "investment_memos_deal_id_fkey" FOREIGN KEY ("deal_id") REFERENCES "public"."pe_deals"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."knowledge_pending_review"
    ADD CONSTRAINT "knowledge_pending_review_reviewed_by_fkey" FOREIGN KEY ("reviewed_by") REFERENCES "auth"."users"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."memo_section_validations"
    ADD CONSTRAINT "memo_section_validations_actor_id_fkey" FOREIGN KEY ("actor_id") REFERENCES "auth"."users"("id");



ALTER TABLE ONLY "public"."memo_section_validations"
    ADD CONSTRAINT "memo_section_validations_section_id_fkey" FOREIGN KEY ("section_id") REFERENCES "public"."memo_sections"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."memo_sections"
    ADD CONSTRAINT "memo_sections_last_edited_by_fkey" FOREIGN KEY ("last_edited_by") REFERENCES "auth"."users"("id");



ALTER TABLE ONLY "public"."memo_sections"
    ADD CONSTRAINT "memo_sections_version_id_fkey" FOREIGN KEY ("version_id") REFERENCES "public"."memo_versions"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."memo_versions"
    ADD CONSTRAINT "memo_versions_generated_by_user_id_fkey" FOREIGN KEY ("generated_by_user_id") REFERENCES "auth"."users"("id");



ALTER TABLE ONLY "public"."memo_versions"
    ADD CONSTRAINT "memo_versions_memo_id_fkey" FOREIGN KEY ("memo_id") REFERENCES "public"."investment_memos"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."memo_versions"
    ADD CONSTRAINT "memo_versions_parent_version_id_fkey" FOREIGN KEY ("parent_version_id") REFERENCES "public"."memo_versions"("id");



ALTER TABLE ONLY "public"."memo_versions"
    ADD CONSTRAINT "memo_versions_snapshot_of_version_id_fkey" FOREIGN KEY ("snapshot_of_version_id") REFERENCES "public"."memo_versions"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."memo_versions"
    ADD CONSTRAINT "memo_versions_snapshot_taken_by_fkey" FOREIGN KEY ("snapshot_taken_by") REFERENCES "auth"."users"("id");
...
ALTER TABLE ONLY "public"."organization_presets"
    ADD CONSTRAINT "organization_presets_organization_id_fkey" FOREIGN KEY ("organization_id") REFERENCES "public"."organizations"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."organization_workflows"
    ADD CONSTRAINT "organization_workflows_organization_id_fkey" FOREIGN KEY ("organization_id") REFERENCES "public"."organizations"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."pe_dd_checklist"
    ADD CONSTRAINT "pe_dd_checklist_deal_id_fkey" FOREIGN KEY ("deal_id") REFERENCES "public"."pe_deals"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."pe_dd_checklist"
    ADD CONSTRAINT "pe_dd_checklist_organization_id_fkey" FOREIGN KEY ("organization_id") REFERENCES "public"."organizations"("id");



ALTER TABLE ONLY "public"."pe_dd_checklist"
    ADD CONSTRAINT "pe_dd_checklist_responsable_user_id_fkey" FOREIGN KEY ("responsable_user_id") REFERENCES "auth"."users"("id");



ALTER TABLE ONLY "public"."pe_dd_checklist"
    ADD CONSTRAINT "pe_dd_checklist_verified_by_fkey" FOREIGN KEY ("verified_by") REFERENCES "auth"."users"("id");



ALTER TABLE ONLY "public"."pe_dd_findings"
    ADD CONSTRAINT "pe_dd_findings_applied_to_memo_by_fkey" FOREIGN KEY ("applied_to_memo_by") REFERENCES "auth"."users"("id");



ALTER TABLE ONLY "public"."pe_dd_findings"
    ADD CONSTRAINT "pe_dd_findings_created_by_fkey" FOREIGN KEY ("created_by") REFERENCES "auth"."users"("id");



ALTER TABLE ONLY "public"."pe_dd_findings"
    ADD CONSTRAINT "pe_dd_findings_deal_id_fkey" FOREIGN KEY ("deal_id") REFERENCES "public"."pe_deals"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."pe_dd_findings"
    ADD CONSTRAINT "pe_dd_findings_organization_id_fkey" FOREIGN KEY ("organization_id") REFERENCES "public"."organizations"("id");



ALTER TABLE ONLY "public"."pe_dd_findings"
    ADD CONSTRAINT "pe_dd_findings_related_checklist_id_fkey" FOREIGN KEY ("related_checklist_id") REFERENCES "public"."pe_dd_checklist"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."pe_dd_findings"
    ADD CONSTRAINT "pe_dd_findings_resolved_by_fkey" FOREIGN KEY ("resolved_by") REFERENCES "auth"."users"("id");



ALTER TABLE ONLY "public"."pe_dd_findings"
    ADD CONSTRAINT "pe_dd_findings_source_doc_id_fkey" FOREIGN KEY ("source_doc_id") REFERENCES "public"."pe_deal_documents"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."pe_deal_documents"
    ADD CONSTRAINT "pe_deal_documents_deal_id_fkey" FOREIGN KEY ("deal_id") REFERENCES "public"."pe_deals"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."pe_deal_documents"
    ADD CONSTRAINT "pe_deal_documents_organization_id_fkey" FOREIGN KEY ("organization_id") REFERENCES "public"."organizations"("id");



ALTER TABLE ONLY "public"."pe_deal_documents"
    ADD CONSTRAINT "pe_deal_documents_uploaded_by_fkey" FOREIGN KEY ("uploaded_by") REFERENCES "auth"."users"("id");



ALTER TABLE ONLY "public"."pe_deal_history"
    ADD CONSTRAINT "pe_deal_history_changed_by_fkey" FOREIGN KEY ("changed_by") REFERENCES "auth"."users"("id");



ALTER TABLE ONLY "public"."pe_deal_history"
    ADD CONSTRAINT "pe_deal_history_deal_id_fkey" FOREIGN KEY ("deal_id") REFERENCES "public"."pe_deals"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."pe_deals"
    ADD CONSTRAINT "pe_deals_created_by_fkey" FOREIGN KEY ("created_by") REFERENCES "auth"."users"("id");



ALTER TABLE ONLY "public"."pe_deals"
    ADD CONSTRAINT "pe_deals_enterprise_id_fkey" FOREIGN KEY ("enterprise_id") REFERENCES "public"."enterprises"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."pe_deals"
    ADD CONSTRAINT "pe_deals_lead_analyst_id_fkey" FOREIGN KEY ("lead_analyst_id") REFERENCES "auth"."users"("id");



ALTER TABLE ONLY "public"."pe_deals"
    ADD CONSTRAINT "pe_deals_organization_id_fkey" FOREIGN KEY ("organization_id") REFERENCES "public"."organizations"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."pe_team_assignments"
    ADD CONSTRAINT "pe_team_assignments_analyst_user_id_fkey" FOREIGN KEY ("analyst_user_id") REFERENCES "auth"."users"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."pe_team_assignments"
    ADD CONSTRAINT "pe_team_assignments_assigned_by_fkey" FOREIGN KEY ("assigned_by") REFERENCES "auth"."users"("id");



ALTER TABLE ONLY "public"."pe_team_assignments"
    ADD CONSTRAINT "pe_team_assignments_im_user_id_fkey" FOREIGN KEY ("im_user_id") REFERENCES "auth"."users"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."pe_team_assignments"
    ADD CONSTRAINT "pe_team_assignments_organization_id_fkey" FOREIGN KEY ("organization_id") REFERENCES "public"."organizations"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."pe_valuation"
    ADD CONSTRAINT "pe_valuation_deal_id_fkey" FOREIGN KEY ("deal_id") REFERENCES "public"."pe_deals"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."pe_valuation"
    ADD CONSTRAINT "pe_valuation_generated_by_user_id_fkey" FOREIGN KEY ("generated_by_user_id") REFERENCES "auth"."users"("id");



ALTER TABLE ONLY "public"."pe_valuation"
    ADD CONSTRAINT "pe_valuation_organization_id_fkey" FOREIGN KEY ("organization_id") REFERENCES "public"."organizations"("id") ON DELETE CASCADE;
...
CREATE POLICY "Managers create pending coach invitations" ON "public"."enterprise_coach_invitations" FOR INSERT WITH CHECK (("public"."has_role"("auth"."uid"(), 'super_admin'::"public"."app_role") OR "public"."is_owner_or_admin_of"("organization_id") OR ("public"."get_user_role_in"("organization_id") = 'manager'::"text")));



CREATE POLICY "Managers delete pending coach invitations" ON "public"."enterprise_coach_invitations" FOR DELETE USING (("public"."has_role"("auth"."uid"(), 'super_admin'::"public"."app_role") OR "public"."is_owner_or_admin_of"("organization_id") OR ("public"."get_user_role_in"("organization_id") = 'manager'::"text")));
...
CREATE POLICY "Read pending coach invitations" ON "public"."enterprise_coach_invitations" FOR SELECT USING (("public"."has_role"("auth"."uid"(), 'super_admin'::"public"."app_role") OR "public"."is_member_of"("organization_id")));
...
CREATE POLICY "ai_jobs_select_own_org" ON "public"."ai_jobs" FOR SELECT TO "authenticated" USING ((("user_id" = "auth"."uid"()) OR ("organization_id" IN ( SELECT "om"."organization_id"
...
CREATE POLICY "credit_dossiers_org_member" ON "public"."credit_dossiers" USING (("organization_id" IN ( SELECT "organization_members"."organization_id"
...
CREATE POLICY "efc_select_own_or_coach" ON "public"."enterprise_financial_canonical" FOR SELECT TO "authenticated" USING ((("enterprise_id" IN ( SELECT "enterprises"."id"
   FROM "public"."enterprises"
  WHERE ("enterprises"."user_id" = "auth"."uid"()))) OR ("enterprise_id" IN ( SELECT "enterprise_coaches"."enterprise_id"
   FROM "public"."enterprise_coaches"
  WHERE (("enterprise_coaches"."coach_id" = "auth"."uid"()) AND ("enterprise_coaches"."is_active" = true)))) OR ("enterprise_id" IN ( SELECT "e"."id"
   FROM ("public"."enterprises" "e"
...
CREATE POLICY "funding_lines_org_member" ON "public"."funding_lines" USING (("organization_id" IN ( SELECT "organization_members"."organization_id"
   FROM "public"."organization_members"
  WHERE (("organization_members"."user_id" = "auth"."uid"()) AND ("organization_members"."is_active" = true)))));
...
CREATE POLICY "investment_memos_select" ON "public"."investment_memos" FOR SELECT USING ("public"."can_see_pe_deal"("deal_id", "auth"."uid"()));
...
ALTER TABLE "public"."memo_section_validations" ENABLE ROW LEVEL SECURITY;


CREATE POLICY "memo_section_validations_insert" ON "public"."memo_section_validations" FOR INSERT WITH CHECK ((("actor_id" = "auth"."uid"()) AND ("section_id" IN ( SELECT "ms"."id"
   FROM (("public"."memo_sections" "ms"
     JOIN "public"."memo_versions" "mv" ON (("mv"."id" = "ms"."version_id")))
     JOIN "public"."investment_memos" "im" ON (("im"."id" = "mv"."memo_id")))
  WHERE "public"."can_see_pe_deal"("im"."deal_id", "auth"."uid"())))));



CREATE POLICY "memo_section_validations_select" ON "public"."memo_section_validations" FOR SELECT USING (("section_id" IN ( SELECT "ms"."id"
   FROM (("public"."memo_sections" "ms"
     JOIN "public"."memo_versions" "mv" ON (("mv"."id" = "ms"."version_id")))
     JOIN "public"."investment_memos" "im" ON (("im"."id" = "mv"."memo_id")))
  WHERE "public"."can_see_pe_deal"("im"."deal_id", "auth"."uid"()))));
...
CREATE POLICY "memo_sections_select" ON "public"."memo_sections" FOR SELECT USING (("version_id" IN ( SELECT "mv"."id"
   FROM ("public"."memo_versions" "mv"
     JOIN "public"."investment_memos" "im" ON (("im"."id" = "mv"."memo_id")))
  WHERE "public"."can_see_pe_deal"("im"."deal_id", "auth"."uid"()))));



CREATE POLICY "memo_sections_update" ON "public"."memo_sections" FOR UPDATE USING (("version_id" IN ( SELECT "mv"."id"
   FROM ("public"."memo_versions" "mv"
     JOIN "public"."investment_memos" "im" ON (("im"."id" = "mv"."memo_id")))
  WHERE "public"."can_see_pe_deal"("im"."deal_id", "auth"."uid"())))) WITH CHECK (("version_id" IN ( SELECT "mv"."id"
   FROM ("public"."memo_versions" "mv"
     JOIN "public"."investment_memos" "im" ON (("im"."id" = "mv"."memo_id")))
  WHERE "public"."can_see_pe_deal"("im"."deal_id", "auth"."uid"()))));
...
CREATE POLICY "memo_versions_select" ON "public"."memo_versions" FOR SELECT USING (("memo_id" IN ( SELECT "investment_memos"."id"
   FROM "public"."investment_memos"
  WHERE "public"."can_see_pe_deal"("investment_memos"."deal_id", "auth"."uid"()))));
...
ALTER TABLE "public"."pe_dd_checklist" ENABLE ROW LEVEL SECURITY;


CREATE POLICY "pe_dd_checklist_delete" ON "public"."pe_dd_checklist" FOR DELETE USING (("public"."can_see_pe_deal"("deal_id", "auth"."uid"()) AND (EXISTS ( SELECT 1
   FROM "public"."organization_members" "om"
  WHERE (("om"."user_id" = "auth"."uid"()) AND ("om"."organization_id" = "pe_dd_checklist"."organization_id") AND ("om"."role" = ANY (ARRAY['managing_director'::"text", 'admin'::"text", 'owner'::"text"])) AND ("om"."is_active" = true))))));



CREATE POLICY "pe_dd_checklist_insert" ON "public"."pe_dd_checklist" FOR INSERT WITH CHECK (("public"."can_see_pe_deal"("deal_id", "auth"."uid"()) AND ("organization_id" IN ( SELECT "om"."organization_id"
   FROM "public"."organization_members" "om"
  WHERE (("om"."user_id" = "auth"."uid"()) AND ("om"."is_active" = true))))));



CREATE POLICY "pe_dd_checklist_select" ON "public"."pe_dd_checklist" FOR SELECT USING ("public"."can_see_pe_deal"("deal_id", "auth"."uid"()));



CREATE POLICY "pe_dd_checklist_update" ON "public"."pe_dd_checklist" FOR UPDATE USING ("public"."can_see_pe_deal"("deal_id", "auth"."uid"()));



ALTER TABLE "public"."pe_dd_findings" ENABLE ROW LEVEL SECURITY;


CREATE POLICY "pe_dd_findings_delete" ON "public"."pe_dd_findings" FOR DELETE USING (("public"."can_see_pe_deal"("deal_id", "auth"."uid"()) AND (("created_by" = "auth"."uid"()) OR (EXISTS ( SELECT 1
   FROM "public"."organization_members" "om"
  WHERE (("om"."user_id" = "auth"."uid"()) AND ("om"."organization_id" = "pe_dd_findings"."organization_id") AND ("om"."role" = ANY (ARRAY['managing_director'::"text", 'admin'::"text", 'owner'::"text"])) AND ("om"."is_active" = true)))))));



CREATE POLICY "pe_dd_findings_insert" ON "public"."pe_dd_findings" FOR INSERT WITH CHECK ((("created_by" = "auth"."uid"()) AND "public"."can_see_pe_deal"("deal_id", "auth"."uid"()) AND ("organization_id" IN ( SELECT "om"."organization_id"
   FROM "public"."organization_members" "om"
  WHERE (("om"."user_id" = "auth"."uid"()) AND ("om"."is_active" = true))))));



CREATE POLICY "pe_dd_findings_select" ON "public"."pe_dd_findings" FOR SELECT USING ("public"."can_see_pe_deal"("deal_id", "auth"."uid"()));



CREATE POLICY "pe_dd_findings_update" ON "public"."pe_dd_findings" FOR UPDATE USING ("public"."can_see_pe_deal"("deal_id", "auth"."uid"()));



ALTER TABLE "public"."pe_deal_documents" ENABLE ROW LEVEL SECURITY;


CREATE POLICY "pe_deal_documents_delete" ON "public"."pe_deal_documents" FOR DELETE USING ("public"."can_see_pe_deal"("deal_id", "auth"."uid"()));



CREATE POLICY "pe_deal_documents_insert" ON "public"."pe_deal_documents" FOR INSERT WITH CHECK ("public"."can_see_pe_deal"("deal_id", "auth"."uid"()));



CREATE POLICY "pe_deal_documents_select" ON "public"."pe_deal_documents" FOR SELECT USING ("public"."can_see_pe_deal"("deal_id", "auth"."uid"()));



ALTER TABLE "public"."pe_deal_history" ENABLE ROW LEVEL SECURITY;


CREATE POLICY "pe_deal_history_select" ON "public"."pe_deal_history" FOR SELECT USING ("public"."can_see_pe_deal"("deal_id", "auth"."uid"()));
...
CREATE POLICY "pe_deals_insert" ON "public"."pe_deals" FOR INSERT WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."organization_members"
  WHERE (("organization_members"."organization_id" = "pe_deals"."organization_id") AND ("organization_members"."user_id" = "auth"."uid"()) AND ("organization_members"."is_active" = true) AND ("organization_members"."role" = ANY (ARRAY['owner'::"text", 'admin'::"text", 'managing_director'::"text", 'investment_manager'::"text", 'analyst'::"text"]))))));



CREATE POLICY "pe_deals_select" ON "public"."pe_deals" FOR SELECT USING ("public"."can_see_pe_deal"("id", "auth"."uid"()));



CREATE POLICY "pe_deals_update" ON "public"."pe_deals" FOR UPDATE USING ("public"."can_see_pe_deal"("id", "auth"."uid"())) WITH CHECK ("public"."can_see_pe_deal"("id", "auth"."uid"()));



ALTER TABLE "public"."pe_team_assignments" ENABLE ROW LEVEL SECURITY;


CREATE POLICY "pe_team_modify" ON "public"."pe_team_assignments" USING ("public"."is_pe_md_or_owner"("organization_id", "auth"."uid"())) WITH CHECK ("public"."is_pe_md_or_owner"("organization_id", "auth"."uid"()));



CREATE POLICY "pe_team_select" ON "public"."pe_team_assignments" FOR SELECT USING (("public"."is_pe_md_or_owner"("organization_id", "auth"."uid"()) OR ("im_user_id" = "auth"."uid"()) OR ("im_user_id" IN ( SELECT "t"."im_user_id"
   FROM "public"."pe_team_assignments" "t"
  WHERE (("t"."analyst_user_id" = "auth"."uid"()) AND ("t"."is_active" = true))))));



ALTER TABLE "public"."pe_valuation" ENABLE ROW LEVEL SECURITY;


CREATE POLICY "pe_valuation_delete" ON "public"."pe_valuation" FOR DELETE USING (("public"."can_see_pe_deal"("deal_id", "auth"."uid"()) AND (EXISTS ( SELECT 1
   FROM "public"."organization_members" "om"
  WHERE (("om"."user_id" = "auth"."uid"()) AND ("om"."organization_id" = "pe_valuation"."organization_id") AND ("om"."is_active" = true) AND ("om"."role" = ANY (ARRAY['owner'::"text", 'admin'::"text", 'managing_director'::"text"])))))));



CREATE POLICY "pe_valuation_insert" ON "public"."pe_valuation" FOR INSERT WITH CHECK (("public"."can_see_pe_deal"("deal_id", "auth"."uid"()) AND ("organization_id" IN ( SELECT "om"."organization_id"
   FROM "public"."organization_members" "om"
  WHERE (("om"."user_id" = "auth"."uid"()) AND ("om"."is_active" = true))))));



CREATE POLICY "pe_valuation_select" ON "public"."pe_valuation" FOR SELECT USING ("public"."can_see_pe_deal"("deal_id", "auth"."uid"()));



CREATE POLICY "pe_valuation_update" ON "public"."pe_valuation" FOR UPDATE USING ("public"."can_see_pe_deal"("deal_id", "auth"."uid"()));



CREATE POLICY "presets_org_member" ON "public"."organization_presets" USING (("organization_id" IN ( SELECT "organization_members"."organization_id"
   FROM "public"."organization_members"
  WHERE (("organization_members"."user_id" = "auth"."uid"()) AND ("organization_members"."is_active" = true)))));
...
CREATE POLICY "super_admin select knowledge_enrichment_log" ON "public"."knowledge_enrichment_log" FOR SELECT USING ((EXISTS ( SELECT 1
   FROM "public"."user_roles"
  WHERE (("user_roles"."user_id" = "auth"."uid"()) AND ("user_roles"."role" = 'super_admin'::"public"."app_role")))));



CREATE POLICY "super_admin select knowledge_pending_review" ON "public"."knowledge_pending_review" FOR SELECT USING ((EXISTS ( SELECT 1
   FROM "public"."user_roles"
  WHERE (("user_roles"."user_id" = "auth"."uid"()) AND ("user_roles"."role" = 'super_admin'::"public"."app_role")))));



CREATE POLICY "super_admin update knowledge_pending_review" ON "public"."knowledge_pending_review" FOR UPDATE USING ((EXISTS ( SELECT 1
   FROM "public"."user_roles"
  WHERE (("user_roles"."user_id" = "auth"."uid"()) AND ("user_roles"."role" = 'super_admin'::"public"."app_role")))));
...
CREATE POLICY "workflows_org_member" ON "public"."organization_workflows" USING (("organization_id" IN ( SELECT "organization_members"."organization_id"
   FROM "public"."organization_members"
  WHERE (("organization_members"."user_id" = "auth"."uid"()) AND ("organization_members"."is_active" = true)))));
...
ALTER PUBLICATION "supabase_realtime" ADD TABLE ONLY "public"."ai_jobs";
...
GRANT ALL ON FUNCTION "public"."can_access_documents_object"("_name" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."can_access_documents_object"("_name" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."can_access_documents_object"("_name" "text") TO "service_role";



GRANT ALL ON FUNCTION "public"."can_see_pe_deal"("p_deal_id" "uuid", "p_user_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."can_see_pe_deal"("p_deal_id" "uuid", "p_user_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."can_see_pe_deal"("p_deal_id" "uuid", "p_user_id" "uuid") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."enforce_pe_deal_invariants"() TO "anon";
GRANT ALL ON FUNCTION "public"."enforce_pe_deal_invariants"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."enforce_pe_deal_invariants"() TO "service_role";



GRANT ALL ON FUNCTION "public"."generate_pe_deal_ref"() TO "anon";
GRANT ALL ON FUNCTION "public"."generate_pe_deal_ref"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."generate_pe_deal_ref"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."get_pe_role"("p_org_id" "uuid", "p_user_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."get_pe_role"("p_org_id" "uuid", "p_user_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."get_pe_role"("p_org_id" "uuid", "p_user_id" "uuid") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."has_enterprise_access"("_enterprise_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."has_enterprise_access"("_enterprise_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."has_enterprise_access"("_enterprise_id" "uuid") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."is_pe_md_or_owner"("p_org_id" "uuid", "p_user_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."is_pe_md_or_owner"("p_org_id" "uuid", "p_user_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."is_pe_md_or_owner"("p_org_id" "uuid", "p_user_id" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."is_supervising_analyst"("p_org_id" "uuid", "p_im_user" "uuid", "p_analyst_user" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."is_supervising_analyst"("p_org_id" "uuid", "p_im_user" "uuid", "p_analyst_user" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."is_supervising_analyst"("p_org_id" "uuid", "p_im_user" "uuid", "p_analyst_user" "uuid") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."pe_create_memo_snapshot"("p_version_id" "uuid", "p_label" "text", "p_user_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."pe_create_memo_snapshot"("p_version_id" "uuid", "p_label" "text", "p_user_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."pe_create_memo_snapshot"("p_version_id" "uuid", "p_label" "text", "p_user_id" "uuid") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."set_memo_sections_updated_at"() TO "anon";
GRANT ALL ON FUNCTION "public"."set_memo_sections_updated_at"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."set_memo_sections_updated_at"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."set_pe_deal_documents_uploaded_by"() TO "anon";
GRANT ALL ON FUNCTION "public"."set_pe_deal_documents_uploaded_by"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."set_pe_deal_documents_uploaded_by"() TO "service_role";
...
GRANT ALL ON FUNCTION "public"."track_pe_deal_stage_change"() TO "anon";
GRANT ALL ON FUNCTION "public"."track_pe_deal_stage_change"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."track_pe_deal_stage_change"() TO "service_role";



GRANT ALL ON FUNCTION "public"."update_efc_timestamp"() TO "anon";
GRANT ALL ON FUNCTION "public"."update_efc_timestamp"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."update_efc_timestamp"() TO "service_role";



GRANT ALL ON FUNCTION "public"."update_pe_dd_updated_at"() TO "anon";
GRANT ALL ON FUNCTION "public"."update_pe_dd_updated_at"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."update_pe_dd_updated_at"() TO "service_role";
...
GRANT ALL ON TABLE "public"."credit_dossiers" TO "anon";
GRANT ALL ON TABLE "public"."credit_dossiers" TO "authenticated";
GRANT ALL ON TABLE "public"."credit_dossiers" TO "service_role";
...
GRANT ALL ON TABLE "public"."enterprise_coach_invitations" TO "anon";
GRANT ALL ON TABLE "public"."enterprise_coach_invitations" TO "authenticated";
GRANT ALL ON TABLE "public"."enterprise_coach_invitations" TO "service_role";
...
GRANT ALL ON TABLE "public"."enterprise_financial_canonical" TO "anon";
GRANT ALL ON TABLE "public"."enterprise_financial_canonical" TO "authenticated";
GRANT ALL ON TABLE "public"."enterprise_financial_canonical" TO "service_role";
...
GRANT ALL ON TABLE "public"."funding_lines" TO "anon";
GRANT ALL ON TABLE "public"."funding_lines" TO "authenticated";
GRANT ALL ON TABLE "public"."funding_lines" TO "service_role";
...
GRANT ALL ON TABLE "public"."knowledge_enrichment_log" TO "anon";
GRANT ALL ON TABLE "public"."knowledge_enrichment_log" TO "authenticated";
GRANT ALL ON TABLE "public"."knowledge_enrichment_log" TO "service_role";



GRANT ALL ON TABLE "public"."knowledge_pending_review" TO "anon";
GRANT ALL ON TABLE "public"."knowledge_pending_review" TO "authenticated";
GRANT ALL ON TABLE "public"."knowledge_pending_review" TO "service_role";
...
GRANT ALL ON TABLE "public"."memo_section_validations" TO "anon";
GRANT ALL ON TABLE "public"."memo_section_validations" TO "authenticated";
GRANT ALL ON TABLE "public"."memo_section_validations" TO "service_role";



GRANT ALL ON TABLE "public"."memo_sections" TO "anon";
GRANT ALL ON TABLE "public"."memo_sections" TO "authenticated";
GRANT ALL ON TABLE "public"."memo_sections" TO "service_role";



GRANT ALL ON TABLE "public"."memo_versions" TO "anon";
GRANT ALL ON TABLE "public"."memo_versions" TO "authenticated";
GRANT ALL ON TABLE "public"."memo_versions" TO "service_role";
...
GRANT ALL ON TABLE "public"."organization_presets" TO "anon";
GRANT ALL ON TABLE "public"."organization_presets" TO "authenticated";
GRANT ALL ON TABLE "public"."organization_presets" TO "service_role";



GRANT ALL ON TABLE "public"."organization_workflows" TO "anon";
GRANT ALL ON TABLE "public"."organization_workflows" TO "authenticated";
GRANT ALL ON TABLE "public"."organization_workflows" TO "service_role";
...
GRANT ALL ON TABLE "public"."pe_dd_checklist" TO "anon";
GRANT ALL ON TABLE "public"."pe_dd_checklist" TO "authenticated";
GRANT ALL ON TABLE "public"."pe_dd_checklist" TO "service_role";



GRANT ALL ON TABLE "public"."pe_dd_findings" TO "anon";
GRANT ALL ON TABLE "public"."pe_dd_findings" TO "authenticated";
GRANT ALL ON TABLE "public"."pe_dd_findings" TO "service_role";



GRANT ALL ON TABLE "public"."pe_deal_documents" TO "anon";
GRANT ALL ON TABLE "public"."pe_deal_documents" TO "authenticated";
GRANT ALL ON TABLE "public"."pe_deal_documents" TO "service_role";



GRANT ALL ON TABLE "public"."pe_deal_history" TO "anon";
GRANT ALL ON TABLE "public"."pe_deal_history" TO "authenticated";
GRANT ALL ON TABLE "public"."pe_deal_history" TO "service_role";



GRANT ALL ON TABLE "public"."pe_deals" TO "anon";
GRANT ALL ON TABLE "public"."pe_deals" TO "authenticated";
GRANT ALL ON TABLE "public"."pe_deals" TO "service_role";



GRANT ALL ON TABLE "public"."pe_team_assignments" TO "anon";
GRANT ALL ON TABLE "public"."pe_team_assignments" TO "authenticated";
GRANT ALL ON TABLE "public"."pe_team_assignments" TO "service_role";



GRANT ALL ON TABLE "public"."pe_valuation" TO "anon";
GRANT ALL ON TABLE "public"."pe_valuation" TO "authenticated";
GRANT ALL ON TABLE "public"."pe_valuation" TO "service_role";
